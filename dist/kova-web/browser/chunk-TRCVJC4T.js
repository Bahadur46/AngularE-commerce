...
// src/app/core/services/notify.ts
var Notify = class _Notify {
  snackBar = inject(MatSnackBar);
  /** Confirmations use the past tense of the action that caused them. */
  done(message) {
    this.snackBar.open(message, "Dismiss", { duration: 3e3 });
  }
  problem(message) {
    this.snackBar.open(message, "Dismiss", { duration: 6e3, panelClass: "Kova-error" });
  }
  static \u0275fac = function Notify_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Notify)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _Notify, factory: _Notify.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Notify, [{
    type: Injectable,
...
//# sourceMappingURL=chunk-TRCVJC4T.js.map
